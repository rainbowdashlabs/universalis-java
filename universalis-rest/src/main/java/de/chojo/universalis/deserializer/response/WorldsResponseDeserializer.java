 ...
 */
public class WorldsResponseDeserializer extends ValueDeserializer<WorldsResponse> {
    @Override
    public WorldsResponse deserialize(JsonParser p, DeserializationContext ctxt) {
